...
function savedLong(a) {
	...
	if (a.checked == true) {
		nvlong.value='on';
		try{
		label_nvlong.className="ico_keep_check on";
		}catch(e){}
		ipCheckOff();
	}
	else
	{
		nvlong.value='off';
		try{
		label_nvlong.className="ico_keep_check";
		}catch(e){}
	}
}
function ipCheckOff() {
	...
	if (check != null) {
		check.checked = false;
		label_check.className="security";
		label_check.innerHTML="OFF";
	}
	setSmartLevel(-1);
}
function ipCheckOn(level) {
	...
	if (check != null) {
		check.checked = true;
		label_check.className="security on";
		label_check.innerHTML="ON";
	}
	setSmartLevel(level);
}
