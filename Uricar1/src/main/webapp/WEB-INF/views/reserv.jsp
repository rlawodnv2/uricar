...
<body>
	...
	<section class="s1">
		<img class="map" src="resources/images/map.png" width="500"
			height="400">
		...
		<div class="reserv">
			...
			<table>
				<tr>
					<td>
						<br> <br>주소 : <input type="text" name="address"
						style="width: 300px; height: 30px;" required /><button type="button" class="btn_type90"
							style="width: 60px; height: 32px;" onclick="openZipSearch()">주소검색</button>
				</tr>
			</table>
				<br> 

				<form name="weather" action="값을 보낼 주소" method="post">
					날짜 <input type="date" name='rentW' width="100%" /> - <input
						type="date" name='returnW' />
				</form>
				<br>
				<form class="time" action="값을 보낼 주소" method="post">
					시간 <input type="time" name="rentT" /> - <input type="time"
						name="returnT" />
			...
			<button type="submit" class="search"
				onclick="location.href='#result'">검색하기</button>
		</div>
		
	</section>

	<section class="s2">
		<div id="result" style="display: none;">살려주세요</div>
