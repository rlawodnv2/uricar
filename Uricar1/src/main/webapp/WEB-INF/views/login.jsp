...
<body>
   ...
   <table style="margin-bottom: 200px; margin-left: 100px;">
      <tbody align="center">
         <tr>
            <td align="center"><img src="resources/images/loginFrm/companylogin.jpg" alt="" usemap="#map01" style="margin-left: 600px; margin-top: -300px;"/>
            <map name="map01" id="map01">
                  <area shape="rect" coords="8,240,303,293" href="./jo">
               </map></td>
            <td align="center">
            <img src="resources/images/loginFrm/memberlogin.jpg" alt="" usemap="#map02" style="margin-right: 400px; margin-top: -300px;"/>
