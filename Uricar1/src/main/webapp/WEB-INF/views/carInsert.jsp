...
<body>
	...
	<div id="menuLeft">
		...
		<dl id="left_nav">
			...
			<dd>
				<a href="javascript:void(0)" class="on"
					onclick="javascript:$('input[name=PARENT_MENU_CD]').val('');$('input[name=LEFT_MENU_CD]').val('G1002');$('input[name=TOP_MENU_CD]').val('G1000');goMenu('G1002','http://localhost/controller/cmInfo2');">제휴사
					소개 </a>
			</dd>
	...
	<div class="box11">
		<form name="insertCar" action="insertCar" method="post">
			<h3>
				<strong>차량 설정</strong>
			</h3>
			...
			<table brder="" bgcolor="#FFFFFF" cellspacing="1">
				...
				<tr>
					<td>차량 번호</td>
					<td><input type="text" size="10" name="car_num" /> <input
			...
			<button type="submit" class="btn_type80">취소</button>
		</form>
	</div>
	<footer>
